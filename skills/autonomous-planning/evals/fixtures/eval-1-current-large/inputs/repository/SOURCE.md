...
- Nature: selected real source/document copies vendored for an isolated Planning eval, not a runnable fork and not synthetic product stubs
...
The selected slice is intentionally incomplete. Planning must distinguish inspected facts from missing repository areas, and must not claim the fixture proves behavior outside these copied paths.
